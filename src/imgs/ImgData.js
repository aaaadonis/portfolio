...
const Data = [
  ...
  },
  {
    ...
    words: "If I'm proud of anything, it's this right here. A video shot to showcase my Physical Computing final. An NFT Smart Mirror, loaded with modules, including a custom module to display the NFT. Technologies used, HTML, CSS, JS, Python, Raspberry Pi.",
    isOn: true,
  ...
  },
  {
    ...
    words: "A live chat site I built for a clothing brand. It includes different interactivities, primarily pertaining to the chat. Messages are sent and received in realtime. Technologies used, React, CSS, Firebase. Deployed with Vercel.",
    isOn: true,
  ...
  },
  {
    ...
    words: "A photo portfolio I built for photographer, Lumia Nocito. Technologies used, React, React Router Dom, Styled Components, Device Detect, Python.",
    isOn: false,
  ...
  },
  {
    ...
    descrip: "Hardies",
    words: "A webstore I built for Pro Skateboarder Tyshawn Jones' brand, Hardies Hardware. Technologies used, Shopify Liquid, HTML, CSS.",
    isOn: false,
  ...
  },
  {
    ...
    words: "My old portfolio. It was very fun to build and whilst displaying novicity, also showed my budding creativity. Technologies used, HTML, CSS, Vanilla JS, JQuery. Deployed using Github Pages.",
    isOn: false,
